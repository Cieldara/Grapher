                        ...
                        switch (event.getEventType().getName()) {
                            case "MOUSE_DRAGGED":
                                switch (event.getButton()) {
                                    ...
                                    case SECONDARY:
                                        redraw();
                                        double x = min(event.getX(), point.getX());
                                        double y = min(event.getY(), point.getY());
                                        double width = Math.abs(event.getX() - point.getX());
                                        double height = Math.abs(event.getY() - point.getY());
                                        GraphicsContext gc = getGraphicsContext2D();
                                        pointRectOrigin = new Point2D(x, y);
                                        pointRect2 = new Point2D(x + width, y + height);
